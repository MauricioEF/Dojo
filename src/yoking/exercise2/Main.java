...
public class Main {
	public static void main(String[] args) {
		...
		if (measurement < 2) {
			System.out.println("medición muy baja");
		}

		if (measurement > 2 && measurement <= 5) {
			System.out.println("medición baja");
		}

		if (measurement > 5 && measurement <= 8) {
			System.out.println("medicion alta");
		}

		if (measurement > 8 && measurement <= 10) {
			System.out.println("medición muy alta");
		}
	}
}